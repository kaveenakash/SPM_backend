...
const {StorePropertyListing,getAllPropertyData,getPropertyById,removeProperty,approveProperty,getAll,getAllPendingPropertyData} = require('../controllers/PropertyController')


router.post('/add-property',fileUpload.single('image'),StorePropertyListing)
router.get('/get-all-property',getAllPropertyData)
router.get('/get-pending-property',getAllPendingPropertyData)
